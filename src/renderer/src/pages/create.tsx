				...
				<form className="w-full max-w-96 mt-4" onSubmit={handleAddCustomer}>
					<div className="mb-2">
						...
						<input 
							...
							className="w-full h-9 rounded text-black px-2 outline-none"
							ref={nameRef}
						/>
					</div>
					...
					<button
						type="submit"
						className="bg-blue-500 rounded flex items-center justify-center w-full h-9 disabled:bg-gray-500 disabled:opacity-50 disabled:cursor-not-allowed"
						disabled={isPending}
					>Cadastrar</button>
